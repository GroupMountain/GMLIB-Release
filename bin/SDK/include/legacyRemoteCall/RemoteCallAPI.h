...
GMLIB_API extern CallbackFn const EMPTY_FUNC;
GMLIB_API ll::Expected<bool> exportFunc(
    std::string const& nameSpace,
    std::string const& funcName,
    CallbackFn&&       callback,
    void*              handle = ll::sys_utils::getCurrentModuleHandle()
);
GMLIB_API CallbackFn const& importFunc(std::string const& nameSpace, std::string const& funcName);
...
GMLIB_API ll::Expected<bool> hasFunc(std::string const& nameSpace, std::string const& funcName);
