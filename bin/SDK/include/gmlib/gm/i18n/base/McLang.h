...
public:
    ...
    GMLIB_NDAPI       McLang(const McLang&);
    GMLIB_NDAPI       McLang(McLang&&) noexcept;
    GMLIB_API McLang& operator=(const McLang&);
    GMLIB_API McLang& operator=(McLang&&) noexcept;

public:
    GMLIB_API virtual ~McLang();
