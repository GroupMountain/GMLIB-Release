...
public:
    GMLIB_NDAPI ICustomItem(std::string const& identifier);

    GMLIB_API ~ICustomItem();
    ...
    GMLIB_API virtual bool isDiggerItem() const;
    ...
    GMLIB_API float getDestroySpeed(::ItemStackBase const& item, ::Block const& block) const override;
