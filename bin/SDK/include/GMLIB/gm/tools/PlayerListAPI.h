...
namespace gmlib::tools::PlayerListAPI {
...
GMLIB_API void
push_back(std::string const& name, std::string const& xuid, mce::UUID const& uuid = mce::UUID::random(), PlayerPermissionLevel permission = PlayerPermissionLevel::Member);
